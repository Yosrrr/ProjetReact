...
function BlogApp() {
    ...
    return [
      {
        ...
        author: 'Alice',
        content: 'React est une bibliothèque JavaScript pour créer des interfaces dynamiques.',
        likes: 5,
      ...
      },
      {
        ...
        author: 'Bob',
        content: 'Les hooks révolutionnent la manière dont on gère l’état dans React.',
        likes: 3,
        createdAt: new Date().toISOString()
      }
    ];
  ...
  return (
    <div style={{
      ...
      <h1 style={{ textAlign: 'center', color: '#2c3e50' }}>📰 Mon Blog Interactif</h1>
